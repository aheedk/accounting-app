...
export default function VendorListPage() {
  ...
  function handleExport() {
    setExcelBusy(true);
    try { downloadAsExcel(dlHeaders, dlRows(), 'vendors'); } finally { setExcelBusy(false); }
  }
