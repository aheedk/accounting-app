...
import { AlertCircle, ChevronDown, FileDown, Printer, Settings, X } from 'lucide-react';
...
export default function BillListPage() {
  ...
  function handleExport() {
    setExcelBusy(true);
    try { downloadAsExcel(dlHeaders, dlRows(), 'bills'); } finally { setExcelBusy(false); }
  }
