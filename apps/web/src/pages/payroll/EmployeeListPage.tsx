...
export default function EmployeeListPage() {
  ...
  function handleExport() {
    setExcelBusy(true);
    try { downloadAsExcel(dlHeaders, dlRows(), 'employees'); } finally { setExcelBusy(false); }
  }
