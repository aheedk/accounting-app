...
export default function PaymentListPage() {
  ...
  function handleExport() {
    setExcelBusy(true);
    try { downloadAsExcel(dlHeaders, dlRows(), 'payments'); } finally { setExcelBusy(false); }
  }
