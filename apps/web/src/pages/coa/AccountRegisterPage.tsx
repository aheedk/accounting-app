...
export default function AccountRegisterPage() {
  ...
  const columns: Column<RegisterRow>[] = [
    ...
    { key: 'source_type', header: 'Type', render: r => sourceLabel(r.source_type) },
    {
      ...
      {state === 'ready' && (
        <Card><CardContent className="p-0">
          <DataTable
            ...
            emptyMessage={<EmptyState title="No transactions yet" hint="Posted journal entries that touch this account will appear here." />}
          />
        </CardContent></Card>
      )}
    </div>
