...
export default function UsersPage() {
  ...
  function handleExport() {
    setExcelBusy(true);
    try { downloadAsExcel(dlHeaders, dlRows(), 'users'); } finally { setExcelBusy(false); }
  }
